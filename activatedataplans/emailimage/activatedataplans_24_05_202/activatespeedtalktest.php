...
$speedtalk_test=new SpeedtalkApi1();
						    ...
						    if(count($getUserDtls)>0)
						    {
							    ...
							    if(count($getDeviceDtls)>0)
							    {
						    		...
						    		if($addr2=="")
						    		{
						    			...
						    			if($getDeviceDtls[0]['phone_number']=="" or $getDeviceDtls[0]['phone_number']==0)
						    			{
						    				...
						    				$response=$speedtalk_test->stActivate($sim_no,$activation_arr);
						    				//print_r($response);
						    				...
						    				if(array_key_exists('ret',$response))
						    				{
							    				if($response['ret']==0)
							    				{
							    					...
							    					$autorefill_res=$speedtalk_test->stAutorefill($watch_phone_number);
						    			...
						    			{
						    				$autorefill_response=$speedtalk_test->stAutorefill($watch_phone_number);
						    			...
						    			$createlistto_klaviyo1['sim']='Speedtalk';
						    			$klaviyo1=array();
