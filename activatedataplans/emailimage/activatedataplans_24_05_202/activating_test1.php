            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <p>This may take up to 4 hours before your device receives service. A confirmation will be sent to the email below when completed. </p>

                     <div class="row device-number device-number-new">
                        <div class="col-3">
                            <img src="<?= IMAGE_PATH.'email-icon.png'?>" width="34" />
                        </div>
                        <div class="col-6">
                            <p class="gray-text text-left"> Email </p>
                            <p id="email_value" class="text-left"><?=$_GET['email']?></p>
                        </div>
                        <!-- <div class="col-3">
                ...
                <div class="error_popup">
                    <div class="error_popup_box wrong_mail_error_box">
                        ...
                        <img src="<?= IMAGE_PATH.'wrong-email-new.png' ?>" srcset="<?= IMAGE_PATH.'wrong-email-new.png 2x' ?>, <?= IMAGE_PATH.'wrong-email-new@3x.png 3x' ?>" alt="signal-icon" class="img-fluid signal-icon wrong_mail_icon">
                            ...
                            <p class="customer_mail"><?=$_GET['email']; ?></p>
...
$(document).click(function(e) {
  ...
  if( e.target.id != 'contact_btn' && e.target.id != 'contact_btn2' && e.target.id != 'contact_btn3' && e.target.id != 'contact_btn4' && e.target.id != 'desk_phone1' && e.target.id != 'desk_email1' && e.target.id != 'mob_phone1' && e.target.id != 'mob_email1'   && e.target.id != 'desk_phone2' && e.target.id != 'desk_email2' && e.target.id != 'mob_phone2' && e.target.id != 'mob_email2'   && e.target.id != 'desk_phone3' && e.target.id != 'desk_email3' && e.target.id != 'mob_phone3' && e.target.id != 'mob_email3' && e.target.id != 'desk_phone4' && e.target.id != 'desk_email4' && e.target.id != 'mob_phone4' && e.target.id != 'mob_email4' ) {
...
function activate(charge_id,email)
{
 ...
 //   $("#activate_btn").hide();
   $.ajax({
            type: 'POST',
            url: 'activatespeedtalktest1.php',
            data: {"charge_id":charge_id,"email":email},
            dataType: 'json',
           // crossDom;ain:true,
            // statusCode:{
