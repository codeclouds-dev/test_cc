...
if(isset($order_dtls['orders'][0]['shopify_order_id']))
{
        ...
        if(count($getdevicedtls)>0) {
                ...
                $first_name=$order_dtls['orders'][0]['billing_address']['first_name'];//echo
                $last_name=$order_dtls['orders'][0]['billing_address']['last_name'];//echo
                $phone=$order_dtls['orders'][0]['billing_address']['phone'];//echo
