...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=CSS_PATH."main-style.css?v=3.5"; ?>">
                ...
                <div class="error_popup">
                    <div class="error_popup_box wrong_mail_error_box">
                        ...
                        <img src="<?= IMAGE_PATH.'wrong-email-new.png' ?>" srcset="<?= IMAGE_PATH.'wrong-email-new.png 2x' ?>, <?= IMAGE_PATH.'wrong-email-new@3x.png 3x' ?>" alt="signal-icon" class="img-fluid signal-icon wrong_mail_icon">
                            ...
                            <p class="acc-mapp">403 | Account mapping</p>
...
$(document).click(function(e) {
  ...
  if( e.target.id != 'contact_btn' && e.target.id != 'contact_btn2' && e.target.id != 'contact_btn3' && e.target.id != 'desk_phone1' && e.target.id != 'desk_email1' && e.target.id != 'mob_phone1' && e.target.id != 'mob_email1'   && e.target.id != 'desk_phone2' && e.target.id != 'desk_email2' && e.target.id != 'mob_phone2' && e.target.id != 'mob_email2'   && e.target.id != 'desk_phone3' && e.target.id != 'desk_email3' && e.target.id != 'mob_phone3' && e.target.id != 'mob_email3' ) {
