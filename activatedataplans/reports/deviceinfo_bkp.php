...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-8 col-12">
      ...
      <div class="col-md-4 col-12 pl-0">From Date: <input type="date" name="from_date" id="from_date" value="<?=isset($_POST['from_date'])?$_POST['from_date']:date('Y-m-d')?>"></div>
      <div class="col-md-4 col-12">To Date: <input type="date" name="to_date" id="to_date" value="<?=isset($_POST['to_date'])?$_POST['to_date']:date('Y-m-d')?>"></div>

      
      <div class="col-md-4 col-12"><input type="submit" name="submit" id="submit" value="Search"></div>
      </form>
...
<?php 
  ...
  else
  {
   ...
   $query="select fullName,phoneNumber,email,imei,sim_no,phone_number,activation_date  from device_details_new join user_mstr on device_details_new.user_id=user_mstr.id where 1".$where." order by activation_date desc";
$arr=array();
$arr['query']=$query;
   ...
   <div class="col-md-12 scroll-page">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td nowrap="nowrap"><?=$val['activation_date'];?></td>
