...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            .scanner_content .manual_imei_box, .manual_imei_box{
                opacity: 0;
                visibility: hidden;
            }
        </style>
            ...
            <section class="container px-0" id="demo-content" class="scanner_content">
                ...
                <div class="scan_page_box d-flex align-items-center position-relative">
                    ...
                    <div class="scan-fxdbtn">
                        <button class="text-left mr-4 px-3" onclick="window.location.href='https://cosmotogether.com/pages/mission-control-new'"><i class='fas fa-arrow-left'></i> Back</button>
                    </div>
