                            ...
                            <div class="col-md-12 col-12 position-relative">
                                <div class="scan-in text-center">
                                    ...
                                    <!-- <div class="scan-fxdbtn">
                                        <button class="text-left mr-4 pl-2" onclick="window.location.href='https://activate.cosmotogether.com/activatedataplans/index.php'"><i class='fas fa-arrow-left'></i> Back</button>
                                    </div> -->
                                </div>
                            </div>
                        </div>
...
<script>
   // A $( document ).ready() block.
    $( document ).ready(function() {
        ...
        //alert('ok');
        $("#qr-reader__scan_region").append('<video muted="true" playsinline="" style="width: 240px; opacity: 0.3;"></video><canvas id="qr-canvas" width="240" height="180" style="width: 240px; height: 180px; display: none;"></canvas><div style="display: none; position: absolute; top: 0px; z-index: 1; background: yellow; text-align: center; width: 100%;">Scanner paused</div>');
