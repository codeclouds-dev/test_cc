...
class WebMailNew
{
        ...
        public function sendAlertDataplan($to,$dataplan_arr)
    {
        ...
        $message='<table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px;width: 100%;margin: 0 auto;    padding: 20px 0;">
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                <td align="left" style="font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: bold; font-size: 24px; color: rgb(45, 50, 65);">Your membership plan is about to renew</td>
            </tr>
            <tr>
                <td align="left" style="font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: 400; font-size: 17px;line-height: 22px; color: rgb(45, 50, 65);padding: 16px 0;">Thanks for being a valued COSMO customer! We wanted to let you know that your (6 Month or Annual) COSMO Membership plan will end/renew on (End/Renewal Date).</td>
            </tr>
            <tr>
                <td align="left" style="font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: 400; font-size: 17px;line-height: 22px; color: rgb(45, 50, 65);padding-bottom: 20px;">By default, your prepaid plan will switch to month-to-month going forward, following the end of your (6 Month/Annual) plan. This means you\'ll continue to receive uninterrupted COSMO service with unlimited talk, text, data, and access to all your COSMO features, billed monthly at $19.99/mo.</td>
            </tr>
            <tr>
                <td align="left" style="font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: 400; font-size: 17px;line-height: 22px; color: rgb(45, 50, 65);padding: 0 0 16px 0;">If you have any questions or would like to make changes to your COSMO Membership, please contact our support team at <a href="tel:(877) 215-4741">(877) 215-4741</a> or reach out via our <a href="https://cosmotogether.com/pages/support" style="color:#2b85c2;">Support Page</a> .</td>
            </tr>
            <tr>
                <td align="left" style="font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: 400; font-size: 17px;line-height: 22px; color: rgb(45, 50, 65);padding-bottom: 20px;">Thanks for choosing COSMO!</td>
            </tr>
            <tr>
    ...
    <style>
       @font-face {
    font-family: "NeuzeitGroW03-Bold";
    src: url('.FONT_PATH.'"NeuzeitGro-Bol.eot");
    src: local("NeuzeitGro-Bol"),
        url('.FONT_PATH.'"NeuzeitGro-Bol.eot?#iefix") format("embedded-opentype"),
        url('.FONT_PATH.'"NeuzeitGro-Bol.woff2") format("woff2"),
        url('.FONT_PATH.'"NeuzeitGro-Bol.woff") format("woff"),
        url('.FONT_PATH.'"NeuzeitGro-Bol.ttf") format("truetype"),
        url('.FONT_PATH.'"NeuzeitGro-Bol.svg#NeuzeitGro-Bol") format("svg");
    font-weight: bold;
    font-style: normal;
    font-display: swap;
}
@font-face {
    font-family: "Neuzeit Grotesk W03 Regular";
    src: url('.FONT_PATH.'"NeuzeitGro-Reg.eot");
    src: local("NeuzeitGro-Reg"),
        url('.FONT_PATH.'"NeuzeitGro-Reg.eot?#iefix") format("embedded-opentype"),
        url('.FONT_PATH.'"NeuzeitGro-Reg.woff2") format("woff2"),
        url('.FONT_PATH.'"NeuzeitGro-Reg.woff") format("woff"),
        url('.FONT_PATH.'"NeuzeitGro-Reg.ttf") format("truetype"),
        url('.FONT_PATH.'"NeuzeitGro-Reg.svg#NeuzeitGro-Reg") format("svg");
    font-weight: normal;
    font-style: normal;
    font-display: swap;
}
...
<body style="margin: 0; padding: 0;">
    <table width="600" cellspacing="0" cellpadding="0" align="center" border="0">
        ...
        <tr>
            <td>
                <p style="margin: 0;color: #2d3241;font-size: 16px;font-family: Arial, Helvetica, sans-serif;">No need to worry! Due to back-to-school demand, we\'re seeing lots of activations and it\'s taking a bit longer to get all devices activated. You\'re in the queue and your device will be activated in the next few hours. We\'ll send you an email as soon as it\'s ready!</p>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        $email = new \SendGrid\Mail\Mail();
        $email->setFrom(SMTPSENDEREMAIL, "COSMO");
        $email->setSubject("Activation Queued");
        $email->addTo($to);
        $email->addContent("text/html", $message);
...
<body>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px;width: 100%;margin: 0 auto;    padding: 20px 0;">
        ...
        <tbody>
            ...
            <tr>
                <td align="center" class="phone_number" style="background-color: rgb(245, 244, 245);padding: 23px 52px; word-break: break-word;font-size: 26px; font-family: neuzeit-grotesk, &quot;Trebuchet MS&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Sans&quot;, Tahoma, sans-serif; font-weight: bold; color: rgb(75, 75, 75);">'.$phone_format.'</td>
            </tr>
            <tr>
