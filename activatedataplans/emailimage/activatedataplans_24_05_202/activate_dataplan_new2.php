		...
		if($hour_diff<1 or 1==1)
		{
			...
			if(empty($getAddrDtls))
			{
				echo "string";
					...
					echo "--".$product_id=checkSubscriptionProductRecharge($product_arr); // return product id exists in the line_items array
					...
					if($product_id)
				    {
				    	echo "string if ";
						    ...
						    $user_arr['selector']="id,fullName,phoneNumber";
						    ...
						    if(count($getUserDtls)>0)
						    {
							    ...
							    if(count($getDeviceDtls)>0)
							    {
							    	...
							    	else
							    	{
						    			...
						    			{
						    			 echo	$phone=$create_subscription['phoneNumber'];
						    			}
