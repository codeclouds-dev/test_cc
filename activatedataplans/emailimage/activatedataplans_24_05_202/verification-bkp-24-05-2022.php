    ...
    <body>
        ...
        <main>
            ...
            <div class="verification_content">
                ...
                <section class="header-sec pt-md-5 pt-sm-4 text-lg-center text-md-left">
                    <div class="container">
                        <div class="row">
                ...
                <!--header section end-->
                <!--verify form start-->
                <section class="verify-form pt-lg-5 mt-lg-5 mt-sm-4 pt-sm-4 pt-5">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="text-lg-center text-md-left">Verify email</h1>
                                <p class="text-lg-center text-md-left my-4">We’ve emailed a verification code to <a href="mailto:johnsmith@gmail.com" class="link-color"><?=$_SESSION['userDtls']['email'];?></a>. Enter the code below to continue with your COSMO device activation.</p>
                                <div class="form-wrapper">
                                    <form method="post" id="otpform">
                                        ...
                                        <div class="bottom-fixed-btns d-flex justify-content-center">
                                            <div class="fixed-btn-wrap d-flex justify-content-center">
