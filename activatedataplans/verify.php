                ...
                <div class="error_popup">
                    <div class="error_popup_box">
                        <div class="popup-info text-center px-2">
                            ...
                            <p class="p2 activation_link"><a href="javascript:void(0)" style="cursor:pointer;" id="actv_message" class="try_btn " style="display:none">Click Here for Activation</a></p>
         ...
         $.ajax({
                   ...
                   success : function(data) {      
                       ...
                       // alert('ddd');
                        ...
                        if(data.response==1)
                        {
                           window.location.href='https://cosmotogether.com/pages/purchase-dataplans-1?clientId='+localStorage.getItem('client_id')+'&sessionId='+localStorage.getItem('session_id')+'&channel='+channel;
                        }
