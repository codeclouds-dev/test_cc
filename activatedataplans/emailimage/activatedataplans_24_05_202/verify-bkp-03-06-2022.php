    ...
    <?php 
        ...
        if ($referer == "App") {
           ...
           $email=str_replace(" ","+",$_REQUEST['email']);
              ...
              header("Location: https://activate.cosmotogether.com/activatedataplans/");
           }
        }
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                ...
                                <div class="activate-ot text-lg-center text-md-left">
                                    <a href="https://activate.cosmotogether.com/activatedataplans/" class="act-ot-btn d-block mx-lg-auto">Activate another device</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="error_popup">
                    <div class="error_popup_box">
                        <div class="popup-info text-center px-2">
                            ...
                            <p class="p2"><a href="#" onclick="submitForm()" style="cursor:pointer;" id="scan_link">Go to Scan Page</a></p>
                            <p class="p2"><a href="appqr.php" style="cursor:pointer;" id="scan_link2">Go to Scan Page</a></p>
                   ...
                   success : function(data) {      
                       ...
                       // alert('ddd');
                        ...
                        else if(data.response==2)
                        {
                            ...
                            $("#actv_message").attr('href','https://activate.cosmotogether.com/activatedataplans/activating.php?charge_id='+data.charge_id+'&email='+data.email);
                            $("#actv_message").show();
                        ...
                        else if(data.response==3)
                        {
                            ...
                            if(referer=='Web')
                            {
                                  window.location='https://activate.cosmotogether.com/activatedataplans/phone.php?pn='+data.phone_no+'&uid='+data.uid;
                            }
                            else
                            {
                                  window.location='https://activate.cosmotogether.com/activatedataplans/success.php?pn='+data.phone_no+"&imei="+data.imei;
                            }  
