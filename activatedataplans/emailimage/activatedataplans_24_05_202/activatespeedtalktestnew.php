						    			...
						    			if($getDeviceDtls[0]['phone_number']=="" or $getDeviceDtls[0]['phone_number']==NULL  or $getDeviceDtls[0]['phone_number']==0)
						    			{
						    				...
						    				if(array_key_exists('ret',$response))
						    				{
							    				if($response['ret']==0)
							    				{
							    					...
							    					{
							    						$json_arr=array("response"=>false,"message"=>"016 | Activation Pending","block"=>"response_block");
							    					}
							    				...
							    				else
							    				{
							    					...
							    					if($response['ret']==1)
							    					{
							    						$json_arr=array("response"=>7,"message"=>"017 | Already submitted or not available.","block"=>"response_block2");
							    					}
							    					else
							    					{
							    						$json_arr=array("response"=>false,"message"=>"006 | Unable to Activate","block"=>"response_block");
