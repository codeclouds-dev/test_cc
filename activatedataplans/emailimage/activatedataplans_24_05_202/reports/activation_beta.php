...
<?php 
 ...
 //    {
 //          $dateTime = $dateTime; 
 //        echo "timezone".  $tz_from = $_SESSION["timezonePhp"]; 
...
<!--         <td nowrap="nowrap" class=""><?=$val['created_date']; ?></td> 
