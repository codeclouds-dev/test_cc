...
function checkSubscriptionProduct($product_arr=array())
{
	...
	{
		if($val['product_id']==7664495755485 or $val['product_id']==7664492970205  or $val['product_id']==7664495198429 or $val['product_id']==8054644113629 or $val['product_id']==8054650699997)
    	{
...
function checkSubscriptionProductRecharge($product_arr=array())
{
	...
	{
		//print_r($val);
		if($val['shopify_product_id']==7664495755485 or $val['shopify_product_id']==7664492970205  or $val['shopify_product_id']==7664495198429 or $val['shopify_product_id']==8054644113629 or $val['shopify_product_id']==8054650699997)
    	{
