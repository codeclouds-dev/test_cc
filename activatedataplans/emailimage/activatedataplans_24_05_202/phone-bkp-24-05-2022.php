      			...
      			<div class="row">
        			 ...
        			 <div class="row device-number">
        			 	...
        			 	<div class="col-6">
        			 		...
        			 		<p id="phone_no"> <a href="tel:(812) 829-0173"><?=$phone; ?></a></p>
        			 	</div>
        			 	<div class="col-3">
        				...
        				<button class="btn btn-blue activate_button" onclick="submitform()" style="cursor:pointer;" > Activate another device </button>
