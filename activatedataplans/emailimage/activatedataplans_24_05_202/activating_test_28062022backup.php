                ...
                <div class="error_popup">
                    <div class="error_popup_box">
                        <div class="popup-info text-center px-2">
                            <img src="<?= IMAGE_PATH.'link_broken.png' ?>" srcset="<?= IMAGE_PATH.'link_broken@2x.png 2x' ?>, <?= IMAGE_PATH.'link_broken@3x.png 3x' ?>" alt="signal-icon" class="img-fluid signal-icon">
                            <h4>Oh no, something went wrong</h4>
                            <p class="p1"  id="message1" class="message1"></p>
                ...
                <div class="error_popup">
                    <div class="error_popup_box wrong_mail_error_box">
                        <div class="popup-info text-center px-2">
                            ...
                            <img src="<?= IMAGE_PATH.'wrong_mail.png' ?>" srcset="<?= IMAGE_PATH.'wrong_mail@2x.png 2x' ?>, <?= IMAGE_PATH.'wrong_mail@3x.png 3x' ?>" alt="signal-icon" class="img-fluid signal-icon wrong_mail_icon">
                            
                            <p class="p1"  id="message2" class="message1">The email you verified doesn’t match the email entered at checkout. Please confirm the email below as primary, or contact customer support to change it.
</p>

                            <p class="customer_mail"><?=$_GET['email']; ?></p>
                            <a href="#" class="try_btn support_popup_btn2 confirm_email_btn" onclick="emailMismatchUpdate()">Confirm email</a>
                            <a href="#" class="try_btn support_popup_btn contact_support_btn">Contact customer support</a>
                           <!--  <p class="p2">Not activating?</p> 
                            <p class="p3"><a href="javascript:void(0);" class="support_popup_btn">Contact customer support for assistance.</a></p>-->
                        </div>
                        <div class="error_support_popup_box d-none d-md-block">
