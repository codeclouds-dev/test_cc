							    				...
							    				if($response['ret']==0)
							    				{
							    					...
							    					if($watch_phone_number!=0 and $trxid!=0)
							    					{
									    					...
									    					else
									    					{
								                                ...
								                                $json_arr=array_merge(array("block"=>"response_block"),$json_arr);
									    					}
							    					...
							    					else
							    					{
							    						...
							    						$mail->activationPending($getUserDtls[0]['email']);
												            ...
												            {
												            	 $actv_pend=array("device_id"=>$getDeviceDtls[0]['id']);
																 //print_r($actv_pend);
																 $db->Insert(ACTIVATION_PENDING,$actv_pend);
												            }
