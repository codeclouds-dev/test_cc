    ...
    <body>
        ...
        <main>
            ...
            <div class="scanner_content">
                <!--scanner main start-->
                <section class="scanner-main d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="container">
                            <p class="text-center">Enter code manually</p>
                                ...
                                <!-- <div class="imei_box_btns d-flex justify-content-between">
                                    ...
                                    <form method="post" id="basic-form" action="verify.php">
                                        <input type="text" name="imei_no" id="imei_no" maxlength="19" class="numberonly form-control required " value="" placeholder="Enter IMEI" >
                                        <div class="imei_box_btns d-flex justify-content-between">
                                            <button type="button" class="cancel_btn">Cancel</button>
