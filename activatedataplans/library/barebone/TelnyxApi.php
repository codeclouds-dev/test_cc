...
class TelnyxApi
{
	...
	public function registerSimCard($registration_code,$tag)
	{
		$Http=new TelnyxHttp();
		$data=array();
	...
	public function validateRegCode($registration_code)
	{
		$Http=new TelnyxHttp();
		$data=array();
		$data["registration_codes"]=[$registration_code];

		$endpoint="sim_cards/actions/validate_registration_codes";
		$sim_dtls=$Http->Post($endpoint,$data);
		//print_r($sim_dtls);
