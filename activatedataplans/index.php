                    ...
                    <div class="row no-gutters">
                        <div class="col-md-12 col-lg-5">
                            <div class="image">
                                ...
                                <div class="imei_logo_box">
                                    <img src="<?= IMAGE_PATH.'cosmo-logo-white.png' ?>" srcset="<?= IMAGE_PATH.'cosmo-logo-white@2x.png 2x' ?>, <?= IMAGE_PATH.'cosmo-logo-white@3x.png 3x' ?>" alt="side image" class=""> 
                                </div>
                            </div>
                        </div>
                   ...
                   <!--  <div class="row">
                         <div class="col-md-12">
                             <div class="nwprogress-bar">
                                <div class="progress">
                                   <div class="progress-bar unq-prgbar" style="width: 0%"></div>
                                </div>
                             </div>
                         </div>
                     </div> -->
        ...
        ?>
            <div class="scanner_mobile1 scanner_content">
             <section class="container px-0" id="demo-content" class="scanner_content">
                    ...
                    <?php 
                        if(isset($_GET['showscan']) and $_GET['showscan']==1)
                        {
                    ?>
                    ...
                    <div class="newscan-info">
                        <div class="scaninfo-txtholder">
                            <h2>To start, scan the QR code on <br /> the back of your watch</h2>
                            
                        </div>
                        <div class="scanimg-wraper">
                            <img src="<?= IMAGE_PATH.'static-scannerimgnew@2x.png' ?>" alt="Scan details" class="img-fluid d-block mx-auto">
                        </div>
                        <button class="btn scannew-btn" onclick="window.location.replace('https://activate.cosmotogether.com/activatedataplans?showscan=1')">Scan now</button>
                    </div>
                    <!---- new scan info end--->
                    <?php
                        }
...
<?php if(isset($_GET['showscan']) and $_GET['showscan']==1){ ?>
...
//alert('sssss');
    ...
    <script>
        ...
        {
            $('.newscan-info').hide();
            $('.scan_page_box').css('display','block !important');
